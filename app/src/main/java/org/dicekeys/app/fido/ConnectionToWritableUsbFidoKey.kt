...
open class ConnectionToWritableUsbFidoKey internal constructor(
    ...
    companion object {
        ...
        /**
         * Check USB device if it's a SoloKey based on ProductId and VendorID
         */
        @JvmStatic
        fun isSoloKey(device: UsbDevice): Boolean {
            return (device.productId == 0x8acf && device.vendorId == 0x10c4) ||
